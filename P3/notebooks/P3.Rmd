...
acuracia <- (90+50)/(142) #0.986

sensibilidade <- (50)/(51) #0.980

especificicade <- 90/(91) #0.989
...
A partir da Tabela \ref{tab:mc} é possível extrair métricas do modelo ajustado e observa-se que a acurácia obtida foi de 98.6%, a sensibilidade foi de 98% e a especificidade foi igual a 98.9%. Para além disso, o erro das simulações variou entre 0.0003 e 3.9409. Estes resultados se assemelham aos obtidos pelo artigo de Silva et.al a partir do uso de Redes Neurais como método para predição de câncer de mama. 
