...
O objetivo deste estudo foi reproduzir o experimento desenvolvido no artigo científico, "A arquitetura das redes de co-morbidade das condições de saúde física e mental dos veteranos militares"
...
# plot(G.oddsmat.3, vertex.size=3, edge.arrow.size = 0.1, 
#      vertex.label.cex=.7,
#      edge.width = E(G.oddsmat.3)$weight/10,
#      vertex.color=colrs[communities$membership])
```

```{r experimento, echo=FALSE, fig.align='center', fig.cap = "Rede gerada a partir da reprodução do experimento do artigo de Alexander-Bloch Aaron F et.al (2020)."}
plot(communities, G.oddsmat.3, vertex.label.cex = 0.5, 
     vertex.label.color = "black", edge.arrow.size = 0.2)
```

```{r original, echo=FALSE, out.width="60%", fig.align='center', fig.cap = "Rede de referência do experimento do artigo de Alexander-Bloch Aaron F et.al (2020)."}
